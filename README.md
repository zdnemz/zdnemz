...
- Building **Mejalin**, a multi-tenant ordering platform for cafés and restaurants — Next.js, Hono, Drizzle/PostgreSQL, Redis
- Maintaining **ShardVeil**, an on-chain card game with 21 audited Solidity contracts and no admin key after deployment
- Freelancing full-time — owning client work end-to-end, from schema to deployment
- Open to **remote contract or full-time roles**
...
I'm open to **remote full-time roles, freelance projects, and collaboration**.
...
<p align="center">
Shipping products. Auditing contracts. 🚀
</p>
